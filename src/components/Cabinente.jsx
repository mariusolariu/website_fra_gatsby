...
export default function Cabinete() {
  const cabinetTimisoaraData = {
    ...
    services: [
      { doctorName1: "Dr. Olariu / Dr. Cristodorescu / Dr. Cirin", title: "Consult cardiologic + EKG + Pulsoximetrie", ioan: "350 RON" },
      { title: "Consult cardiologic + Monitorizare Holter EKG 24H", ioan: "500 RON" },
      { title: "Consult Cardiologic + Monitorizare Holter TA 24H", ioan: "500 RON" },
      { title: "Consult cardiologic + EKG +  Ecocardiografie Doppler 2D Color + Pulsoximetrie", ioan: "550 RON" },
      { title: "Consult cardiologic + Monitorizarea Holter TA+EKG 24H", ioan: "600 RON" },
