    ...
    <>
      <div style={flexcontainer}>
        <p style={{ "text-indent": "1em" }}>
          <strong>Olariu Med Bocșa</strong> se adresează pacienților cu boli cardiovasculare și oferă servicii medicale eficiente la cele mai înalte standarde de calitate.
